package cn.uway.skynet.cloud.auth.endpoint;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.uway.skynet.cloud.auth.dto.Page;
...
public class SkynetCloudTokenEndpoint {
    ...
    public R getTokenPage(@RequestBody Map<String, Object> params, @RequestHeader(required = false) String from) {
        ...
        for (String page : pages) {
            ...
            if (authentication instanceof UsernamePasswordAuthenticationToken) {
                ...
                if (authenticationToken.getPrincipal() instanceof UserDetailIpml) {
                    UserDetailIpml user = (UserDetailIpml) authenticationToken.getPrincipal();
