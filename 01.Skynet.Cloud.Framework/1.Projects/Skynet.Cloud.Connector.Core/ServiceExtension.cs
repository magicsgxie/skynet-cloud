namespace UWay.Skynet.Cloud.Extensions
{
    ...
    public static partial class ServiceExtension
    {
        ...
        ///// </summary>
        ///// <param name="service">服务列表.</param>
        ///// <param name="controllerAssemblyName">controller assembly name.</param>
        ///// <returns>IServiceCollection</returns>
        ...
        /// <param name="configure">配置信息.</param>
        /// <returns>IServiceProvider.</returns>
        public static IServiceContainer BuildAspectCoreServiceContainer(
        ...
        /// <param name="configure">配置信息.</param>
        /// <returns>IServiceProvider.</returns>
        public static IServiceProvider BuildAspectCoreServiceProvider(
            this IServiceCollection services,
            Action<IAspectConfiguration> configure = null)
        {
