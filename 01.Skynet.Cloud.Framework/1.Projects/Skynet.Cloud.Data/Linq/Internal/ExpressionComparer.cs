...
namespace UWay.Skynet.Cloud.Data.Linq.Internal
{
    ...
    class ExpressionComparer
    {
        ...
        class ParameterExpressionComparer : IEqualityComparer<ParameterExpression>
        {
            public static readonly ParameterExpressionComparer Instance = new ParameterExpressionComparer();
        ...
        protected virtual bool CompareLambda(LambdaExpression a, LambdaExpression b)
        {
            ...
            this.parameterScope = new ScopedDictionary<ParameterExpression, ParameterExpression>(this.parameterScope, ParameterExpressionComparer.Instance);
            try
            {
                for (int i = 0; i < n; i++)
                {
