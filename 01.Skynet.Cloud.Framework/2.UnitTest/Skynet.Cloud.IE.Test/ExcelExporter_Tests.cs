...
namespace UWay.Skynet.Cloud.IE.Tests
{
    public class ExcelExporter_Tests : TestBase
    {
        ...
        public async Task ExportByTemplate_Test()
        {
            ...
            await exporter.ExportByTemplate(filePath, new TextbookOrderInfo("湖南心莱信息科技有限公司", "湖南长沙岳麓区", "magic.s.g.xie", "1367197xxxx", "magic.s.g.xie", DateTime.Now.ToLongDateString(), new List<BookInfo>()
            {
