...
### ULinq支持方法
1. Access_SQLServer_Oracle
[Access_SQLServer_Oracle文档](/doc/Access_SQLServer_Oracle_______________.doc)
2. Enum、Guid转化
[EnumAndGuidConverTest](/doc/EnumAndGuidConverTest.xls)
3. 支持的Linq方法
[Functions](/doc/Functions.xls)
