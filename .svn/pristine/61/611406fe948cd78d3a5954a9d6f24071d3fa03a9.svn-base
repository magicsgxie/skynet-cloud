...
namespace UWay.Skynet.Cloud.Data.Linq.Internal
{
    ...
    /// </summary>
    interface IDeferLoadable
    {
        bool IsLoaded { get; }
        void Load();
    }

    interface IDeferredList : IList, IDeferLoadable
    {
    }

    interface IDeferredList<T> : IList<T>, IDeferredList
    {
    }
    ...
    class DeferredList<T> : IDeferredList<T>, ICollection<T>, IEnumerable<T>, IList, ICollection, IEnumerable, IDeferLoadable
    {
