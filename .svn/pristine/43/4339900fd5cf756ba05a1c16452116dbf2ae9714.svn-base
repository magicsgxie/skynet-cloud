...
namespace UWay.Skynet.Cloud.Linq.Impl.Internal.Filtering
{
    using System;
    ...
    internal class FilterDescriptorExpressionBuilder : FilterExpressionBuilder
    {
        ...
        public override Expression CreateBodyExpression()
        {
            ...
            else if (memberType.IsNullable() && (memberExpression.Type != valueExpression.Type))
            {
        ...
        {
            if (((targetType != typeof(string)) && (!targetType.IsValueType || targetType.IsNullable())) &&
        ...
        private static Expression PromoteExpression(Expression expr, Type type, bool exact)
        {
            ...
            if (((ce != null) && (ce == ExpressionConstants.NullLiteral)) && !(type.IsValueType && !type.IsNullable()))
            {
