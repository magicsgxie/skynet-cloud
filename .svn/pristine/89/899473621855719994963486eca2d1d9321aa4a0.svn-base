namespace UWay.Skynet.Cloud.Linq.Impl
{
    ...
    public class FilterLexer
    {
        ...
        private static readonly string[] Nulls = new[] { "null" };
        private static readonly string[] Functions = new[] { "contains", "endswith", "startswith", "notsubstringof", "doesnotcontain","in" };
        ...
        {
            return Array.IndexOf(Nulls, value) > -1;
        }
        ...
        private static FilterToken Null(string result)
        {
