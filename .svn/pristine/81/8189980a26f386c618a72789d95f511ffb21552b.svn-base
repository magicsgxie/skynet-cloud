...
namespace UWay.Skynet.Cloud.Data.Linq.Expressions
{
    ...
    /// </summary>
    class RedundantJoinRemover : DbExpressionVisitor
    {
        Dictionary<TableAlias, TableAlias> map;

        private RedundantJoinRemover()
        {
            this.map = new Dictionary<TableAlias, TableAlias>(TableAlias.Comparer);
        }
        ...
        protected override Expression VisitColumn(ColumnExpression column)
        {
            ...
            {
                return new ColumnExpression(column.Type, column.SqlType, mapped, column.Name);
            }
            return column;
        }
    }
