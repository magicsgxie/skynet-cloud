...
namespace UWay.Skynet.Cloud.Data
{
    ...
    public partial class DbConfiguration
    {
        ...
        internal Func<ILogger> sqlLogger;
        ...
        /// <returns></returns>
        public DbConfiguration SetSqlLogger(Func<ILogger> logger)
        {
            ...
            , DbProviderFactory dbProviderFactory)
        {
            ...
            switch (providerName)
            {
                ...
                case DbProviderNames.MySQL:
                    connectionCreator = () => new DbConnectionWrapper(this, MySqlClientFactory.Instance.CreateConnection()) { ConnectionString = connectionString, IsFileDatabase = true };
                    break;
                ...
                case DbProviderNames.PostgreSQL:
                    connectionCreator = () => new DbConnectionWrapper(this, NpgsqlFactory.Instance.CreateConnection()) { ConnectionString = connectionString};
                    break; 
                default:
                    connectionCreator = () => new DbConnectionWrapper(this, DbProviderFactory.CreateConnection()) { ConnectionString = connectionString };
                    break;
