...
namespace UWay.Skynet.Cloud.Data.Linq.Expressions
{
    ...
    /// </summary>
    abstract class DbExpressionVisitor : UWay.Skynet.Cloud.Data.Linq.ExpressionVisitor
    {
        ...
        protected FunctionExpression UpdateFunction(FunctionExpression func, string name, IEnumerable<Expression> arguments)
        {
            ...
            {
                return new FunctionExpression(func.Type, name, arguments.ToArray());
            }
            return func;
        }
        ...
        protected virtual ReadOnlyCollection<VariableDeclaration> VisitVariableDeclarations(ReadOnlyCollection<VariableDeclaration> decls)
        {
            ...
            for (int i = 0, n = decls.Count; i < n; i++)
            {
                ...
                if (alternate != null)
                {
                    alternate.Add(new VariableDeclaration(decl.Name, decl.SqlType, e));
                }
            }
            if (alternate != null)
            {
