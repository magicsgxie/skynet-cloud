...
* 版本号：  V1.0.0.0
* 唯一标识：82439bff-07cf-4b0c-b109-adc741f45170
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   /// 存放由用户指定的下一步处理人服务接口类
   /// </summary>
   public interface IInstanceStepNextstepUserService
   {
      /// <summary>
      /// 添加存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      long Add(InstanceStepNextstepUser  instanceStepNextstepUser);
      /// <summary>
      /// 添加存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      void Add(IList<InstanceStepNextstepUser>  instanceStepNextstepUsers);
      /// <summary>
      /// 更新存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      int Update(InstanceStepNextstepUser  instanceStepNextstepUser);
      /// <summary>
      ...
      /// </summary>
      InstanceStepNextstepUser GetById(string id);
      /// <summary>
