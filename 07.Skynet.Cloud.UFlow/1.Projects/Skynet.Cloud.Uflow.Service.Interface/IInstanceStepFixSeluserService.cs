...
* 版本号：  V1.0.0.0
* 唯一标识：a3cdf42c-c709-4f9c-b9c2-93e1d103caa7
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   /// 存放由用户指定的下一步处理人服务接口类
   /// </summary>
   public interface IInstanceStepFixSeluserService
   {
      /// <summary>
      /// 添加存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      long Add(InstanceStepFixSeluser  instanceStepFixSeluser);
      /// <summary>
      /// 添加存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      void Add(IList<InstanceStepFixSeluser>  instanceStepFixSelusers);
      /// <summary>
      /// 更新存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      int Update(InstanceStepFixSeluser  instanceStepFixSeluser);
      /// <summary>
      /// 删除存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      int Delete(InstanceStepFixSeluser instanceStepFixSeluser);
      /// <summary>
      /// 获取指定的存放由用户指定的下一步处理人{存放由用户指定的下一步处理人}对象(即:一条记录
      /// </summary>
      InstanceStepFixSeluser GetById(object id);
      /// <summary>
