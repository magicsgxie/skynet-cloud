...
* 版本号：  V1.0.0.0
* 唯一标识：b741f3e4-5ae9-4e56-9d0a-6b9dc2a2d9ba
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   /// 人员处理结果表服务接口类
   /// </summary>
   public interface IHisUserResultService
   {
      /// <summary>
      /// 添加人员处理结果表{人员处理结果表}对象(即:一条记录
      /// </summary>
      long Add(HisUserResult  hisUserResult);
      /// <summary>
      /// 添加人员处理结果表{人员处理结果表}对象(即:一条记录
      /// </summary>
      void Add(IList<HisUserResult>  hisUserResults);
      /// <summary>
      /// 更新人员处理结果表{人员处理结果表}对象(即:一条记录
      /// </summary>
      int Update(HisUserResult  hisUserResult);
      /// <summary>
      ...
      /// </summary>
      HisUserResult GetById(string id);
      /// <summary>
