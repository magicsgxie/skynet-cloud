...
* 版本号：  V1.0.0.0
* 唯一标识：d1c85bbf-4fde-49b4-af86-7367c4671486
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   /// 步骤转入转出条件服务接口类
   /// </summary>
   public interface ITemplateStepConditionService
   {
      /// <summary>
      /// 添加步骤转入转出条件{步骤转入转出条件}对象(即:一条记录
      /// </summary>
      long Add(TemplateStepCondition  templateStepCondition);
      /// <summary>
      /// 添加步骤转入转出条件{步骤转入转出条件}对象(即:一条记录
      /// </summary>
      void Add(IList<TemplateStepCondition>  templateStepConditions);
      /// <summary>
      /// 更新步骤转入转出条件{步骤转入转出条件}对象(即:一条记录
      /// </summary>
      int Update(TemplateStepCondition  templateStepCondition);
      /// <summary>
      ...
      /// </summary>
      TemplateStepCondition GetById(string id);
      /// <summary>
