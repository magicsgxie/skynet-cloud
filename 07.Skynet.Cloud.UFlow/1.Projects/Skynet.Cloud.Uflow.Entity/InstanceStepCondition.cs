...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceStepCondition.cs
* 版本号：  V1.0.0.0
* 唯一标识：f0ccae30-aca7-40db-842e-976fb9f22bb0
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_STEP_CONDITION")]
   public class InstanceStepCondition
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
