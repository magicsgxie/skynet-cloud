...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceStepSubflow.cs
* 版本号：  V1.0.0.0
* 唯一标识：efddda0c-4de6-4905-b151-be8ea32d210f
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_STEP_SUBFLOW")]
   public class InstanceStepSubflow
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
