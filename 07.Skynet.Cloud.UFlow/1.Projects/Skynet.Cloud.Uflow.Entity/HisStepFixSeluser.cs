...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.HisStepFixSeluser.cs
* 版本号：  V1.0.0.0
* 唯一标识：74befe7b-4161-4ec4-8add-8be293abd06c
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_HIS_STEP_FIX_SELUSER")]
   public class HisStepFixSeluser
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
