...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceConditionResult.cs
* 版本号：  V1.0.0.0
* 唯一标识：5c073945-cef2-4b81-a86b-6dc943123ec1
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_CONDITION_RESULT")]
   public class InstanceConditionResult
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
