...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceStepNextSeluser.cs
* 版本号：  V1.0.0.0
* 唯一标识：99159e26-5be0-416a-934e-3af6d98684e0
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_STEP_NEXT_SELUSER")]
   public class InstanceStepNextSeluser
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
