...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceSystemMsg.cs
* 版本号：  V1.0.0.0
* 唯一标识：74c9a733-500a-4403-a8fa-234117bc4614
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_SYSTEM_MSG")]
   public class InstanceSystemMsg
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
