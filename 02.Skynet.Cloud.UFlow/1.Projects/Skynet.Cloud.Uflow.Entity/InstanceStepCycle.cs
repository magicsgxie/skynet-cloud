...
* 文件名：  UWay.Skynet.Cloud.Uflow.Entity.InstanceStepCycle.cs
* 版本号：  V1.0.0.0
* 唯一标识：c3d531f3-d587-47a6-bc73-2ca5f9e3e360
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Entity
{
   ...
   [Table("UF_INSTANCE_STEP_CYCLE")]
   public class InstanceStepCycle
   {
      /// <summary>
      /// 唯一ID
      /// <summary>
