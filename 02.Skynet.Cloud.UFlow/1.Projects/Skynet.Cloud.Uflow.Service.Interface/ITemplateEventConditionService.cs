...
* 版本号：  V1.0.0.0
* 唯一标识：b0ce212a-ee26-4418-a086-f31c553e7f6e
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   /// 事件启用条件服务接口类
   /// </summary>
   public interface ITemplateEventConditionService
   {
      /// <summary>
      /// 添加事件启用条件{事件启用条件}对象(即:一条记录
      /// </summary>
      long Add(TemplateEventCondition  templateEventCondition);
      /// <summary>
      /// 添加事件启用条件{事件启用条件}对象(即:一条记录
      /// </summary>
      void Add(IList<TemplateEventCondition>  templateEventConditions);
      /// <summary>
      /// 更新事件启用条件{事件启用条件}对象(即:一条记录
      /// </summary>
      int Update(TemplateEventCondition  templateEventCondition);
      /// <summary>
      ...
      /// </summary>
      TemplateEventCondition GetById(string id);
      /// <summary>
