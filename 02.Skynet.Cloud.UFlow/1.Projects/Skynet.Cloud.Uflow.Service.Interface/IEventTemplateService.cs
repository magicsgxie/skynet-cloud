...
* 版本号：  V1.0.0.0
* 唯一标识：d4ebf477-6060-4535-920d-efec0406eee6
* 创建人：  magic.s.g.xie
* 电子邮箱：xiesg@uway.cn
...
namespace   UWay.Skynet.Cloud.Uflow.Service.Interface
{
   ...
   public interface IEventTemplateService
   {
      ...
      /// </summary>
      long Add(EventTemplate  eventTemplate);
      /// <summary>
      /// 添加事件模板{事件模板}对象(即:一条记录
      /// </summary>
      void Add(IList<EventTemplate>  eventTemplates);
      /// <summary>
      /// 更新事件模板{事件模板}对象(即:一条记录
      /// </summary>
      int Update(EventTemplate  eventTemplate);
      /// <summary>
